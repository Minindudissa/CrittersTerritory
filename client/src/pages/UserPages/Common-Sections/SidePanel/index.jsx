...
function UserProfileSidePanel() {
  ...
  return (
    <nav
      className={` bg-gray-400 h-full top-0
      ...
      <div className="overflow-auto py-6 h-full mt-4">
        <ul className="space-y-1">
          <li>
            <a
              onClick={() =>
                navigate("../user-profile/my-profile", { replace: true })
              }
          ...
          <li>
            <a
              onClick={() =>
                navigate("../user-profile/my-orders", { replace: true })
              }
