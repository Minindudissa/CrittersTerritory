...
function SidePanel() {
  ...
  return (
    <nav
      className={` bg-black bg-opacity-40 h-full top-0
         left-0 ${isMenuVisible ? "w-56 px-4" : "w-14"}  pb-6
           transform 
      ...
      <div className="overflow-auto py-6 h-full mt-4">
        <ul className="space-y-1">
          <li>
            ...
            >
              ...
              <span style={{ fontWeight: "bold" }}>
                {isMenuVisible ? "Dashboard" : null}
              </span>
            </a>
          </li>
          <li>
            <a
              onClick={() => navigate("../admin/admins", { replace: true })}
          ...
          <li>
            <a
              onClick={() =>
                navigate("../admin/controlRoom", { replace: true })
              }
              className="text-black cursor-pointer  hover:text-yellow-500 text-[15px] flex items-center hover:bg-black hover:bg-opacity-40 rounded px-4 py-3 transition-all"
            >
              <svg
              ...
              <span style={{ fontWeight: "bold" }}>
                {isMenuVisible ? "Control Room" : null}
              </span>
            </a>
          </li>
          <li>
